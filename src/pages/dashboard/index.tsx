  ...
  return (
    <LoginRequired loginRequired={loginRequired}>
      <div className="mb-32 max-w-screen-xl w-full mx-auto">
        <div className="grid md:grid-cols-2 grid-cols-1 gap-14">
          {!isEmpty(progress) && (
            <div className="flex flex-col space-y-2 mt-8">
              <h2 className="text-xl font-semibold pb-2 mb-3 border-b border-gray-200 dark:border-gray-800">
                Continue Learning
              </h2>
          ...
          <div>
            <h1 className="mt-8 text-xl font-semibold pb-2 mb-3 border-b border-gray-200 dark:border-gray-800">
              Bookmarks
            </h1>
        ...
        <div className="mt-20">
          <h1 className="text-xl font-semibold pb-2 mb-3 border-b border-gray-200 dark:border-gray-800">
            Watch History
          </h1>
          <Bookmarks viewer={viewer} />
        </div>
